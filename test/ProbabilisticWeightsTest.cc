...
Eigen::SparseMatrix<double, Eigen::RowMajor> dataAssociation()
{
    Eigen::SparseMatrix<double, Eigen::RowMajor> data_association(2, 4);
    ...
    tripletList.push_back(Eigen::Triplet<double>(1, 2, 1));
