...
PointCloudRegistrationIteration::PointCloudRegistrationIteration(
...
void PointCloudRegistrationIteration::solve(ceres::Solver::Options options,
...
Eigen::Affine3d PointCloudRegistrationIteration::transformation()
{
